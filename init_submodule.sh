...
LINKS=( \
  ...
  "app/design/backend/base/default/layout/$LC_MODULE.xml"
  "app/design/backend/base/default/layout/$LC_MODULE"
  "app/design/backend/base/default/layout/$LC_CONTRIBUTOR/$LC_MODULE.xml"
  "app/design/backend/base/default/template/$LC_MODULE"
  "app/design/backend/base/default/template/$LC_CONTRIBUTOR/$LC_MODULE"
  ...
  "skin/backend/base/default/images/$LC_CONTRIBUTOR/$LC_MODULE"
  "skin/backend/base/default/images/$LC_MODULE"
  "skin/backend/base/default/js/$LC_CONTRIBUTOR/$LC_MODULE"
  "skin/backend/base/default/js/$LC_MODULE.css"
  "skin/backend/base/default/js/$LC_MODULE"
