 ...
 */
class Mage_Devtool_Block_Session_Devtool extends Mage_Devtool_Block_Session_Abstract
{
    /**
     * get session singleton
     *
     * @return Mage_Devtool_Model_Session
     */
    public function getSession()
    {
        return Mage::getSingleton('devtool/session');
    }
}
