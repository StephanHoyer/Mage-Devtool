...
/**
 * Mage_Devtool_Model_Log_Collection
 *
 * @category  Mage
 * @package   Mage_Devtool
 * @author    Stephan Hoyer <stephan.hoyer@netresearch.de>
 ...
 * @link      http://www.netresearch.de/leistungen/magento-ecommerce.html
 */
class Mage_Devtool_Model_Log_Collection extends ArrayObject
{
    /**
     * add log
     *
     * @param Mage_Devtool_Model_Log $log Log
     *
     * @return void
     */
    public function add(Mage_Devtool_Model_Log $log)
    {
        $this->append($log);
    }
}
